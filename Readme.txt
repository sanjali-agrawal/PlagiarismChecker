...
I have also used tf-idf vectorisation to put weights on the words for that are unique and to disregard common words like the, a, then etc.
...
The files with more than 15% similarity is considered plagiarised.
